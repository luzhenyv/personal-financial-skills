"""Generic artifact I/O helpers for earnings-analysis skill scripts.
...
Usage::
    ...
    io = ArtifactIO("NVDA", "earnings")
    io.write_json("Q4_2024.json", {"revenue": 22103000000, ...})
    data = io.read_json("Q4_2024.json")
    io.write_text("Q4_2024_analysis.md", report_md)
"""
...
class ArtifactIO:
    ...
    skill : str
        Skill name used as the subdirectory (e.g. ``"earnings"``).
    """
