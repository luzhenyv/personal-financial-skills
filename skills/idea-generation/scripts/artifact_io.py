"""Generic artifact I/O helpers for idea-generation skill scripts.
...
Usage::
    ...
    io.write_json("screen_results.json", {...})
...
class ArtifactIO:
    ...
    ticker : str
        ...
        like ``"_ideas"`` for non-ticker artifacts.
    skill : str
        Skill name used as the subdirectory (e.g. ``"earnings"``).
        Use empty string for flat artifact directories.
    """
