...
Usage (from within any skill's scripts/ directory)::
    ...
    io.write_json("risk_report.json", {...})
    data = io.read_json("risk_report.json")
    io.write_text("risk_report.md", report_md)
"""
...
class ArtifactIO:
    ...
    skill : str
        Skill name used as the subdirectory (e.g. ``"risk"``).
    """
...
def read_artifact_json(
    ...
    """Read a JSON artifact for any ticker/skill without creating dirs."""
