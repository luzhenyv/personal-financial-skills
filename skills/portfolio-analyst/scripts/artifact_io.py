...
Usage (from within any skill's scripts/ directory)::
    ...
    io.write_json("portfolio_snapshot.json", {...})
    data = io.read_json("portfolio_snapshot.json")
    io.write_text("portfolio_review.md", report_md)
"""
...
class ArtifactIO:
    ...
    skill : str
        Skill name used as the subdirectory (e.g. ``"analysis"``).
    """
