"""Thesis Tracker — dashboard-local artifact storage helpers.

This file is intentionally copied into dashboard/utils so dashboard remains
decoupled from skills runtime modules.
